    ...
    execute: function () {
      ...
      _export("BallCollision", BallCollision = (_dec = ccclass('BallCollision'), _dec(_class = class BallCollision extends Component {
        ...
        onBeginContact(_, other) {
          ...
          console.log("碰撞发生了");
          var selfBall = this.node.getComponent(_crd && ball === void 0 ? (_reportPossibleCrUseOfball({
            error: Error()
          }), ball) : ball);
          var otherBall = other.node.getComponent(_crd && ball === void 0 ? (_reportPossibleCrUseOfball({
            error: Error()
          }), ball) : ball);
          var selfIsBullet = !!(selfBall != null && selfBall.isbullet);
          var otherIsBullet = !!(otherBall != null && otherBall.isbullet);
          ...
          var bulletNode = selfIsBullet ? this.node : other.node;
          var hitNode = selfIsBullet ? other.node : this.node;
          var path = (_director$getScene = director.getScene()) == null ? void 0 : _director$getScene.getComponentInChildren(_crd && ZumaCurvePath === void 0 ? (_reportPossibleCrUseOfZumaCurvePath({
            error: Error()
          }), ZumaCurvePath) : ZumaCurvePath);
          var shooter = (_director$getScene2 = director.getScene()) == null ? void 0 : _director$getScene2.getComponentInChildren(_crd && control === void 0 ? (_reportPossibleCrUseOfcontrol({
            error: Error()
          }), control) : control);
