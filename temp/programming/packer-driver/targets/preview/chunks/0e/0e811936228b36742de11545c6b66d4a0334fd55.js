System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "c64bfAVepdFfZiPtLS09w/w", "ZumaCurvePath.ts", undefined);
      ...
      _export("ZumaPathManager", ZumaPathManager = (_dec = ccclass('ZumaPathManager'), _dec2 = property(Node), _dec3 = property(Prefab), _dec(_class = (_class2 = class ZumaPathManager extends Component {
        ...
        spawnBalls() {
          for (var i = 0; i < this.spawnCount; i++) {
            var ball = instantiate(this.ballPrefab[i % this.ballPrefab.length]);
        ...
        update(dt) {
          for (var i = 0; i < this.balls.length; i++) {
            ...
            var t = this.ballPositions[i % this.balls.length];
        ...
        getPointByT(t) {
          ...
          var localT = t * segments % 1;
          var p0 = this.pathPoints[seg].position; //这段代码是有bug的，但是t和seg与速度相关，当生成数量为5时，速度为0.005时，基本上不会出现越界问题，所以暂时不修复了

          var p1 = this.pathPoints[seg + 1].position;
          var dir = new Vec3();
...
//# sourceMappingURL=0e811936228b36742de11545c6b66d4a0334fd55.js.map